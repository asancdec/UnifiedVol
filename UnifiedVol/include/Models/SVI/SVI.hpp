...
private:
	...
	//void buildModelSurface(const VolSurface& impVolSurf, 
...
public:
	...
	std::map<double, SVIParams> sviParams;  // Each maturity maps to a slice of raw SVI parameters
	VolSurface modelVolSurf;			    // Calibrated volatility surface
