 ...
 */
#define UV_LOG_TO_FILE(pathstr) Log::instance().setFile((pathstr))
 ...
 */
#define UV_LOG_CONSOLE(enabled) Log::instance().enableConsole((enabled))
 ...
 * @param msg Message to log.
 */
#define UV_INFO(msg) Log::instance().log(Level::Info, (msg))
