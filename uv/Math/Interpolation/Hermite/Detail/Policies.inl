...
template <class Derived, std::floating_point T> void Derivatives<Derived, T>::operator()(
    std::span<const T> xs,
    std::span<const T> ys,
    std::span<T> dydx,
    bool doValidate
...
template <std::floating_point T> void PchipDerivatives<T>::derivatives(
    std::span<const T> xs,
    std::span<const T> ys,
    std::span<T> dydx,
    bool doValidate
...
template <class Derived, std::floating_point T> void Evaluate<Derived, T>::operator()(
    std::span<const T> x,
    std::span<const T> xs,
    std::span<const T> ys,
    std::span<const T> dydx,
...
template <class Derived, std::floating_point T> T Evaluate<Derived, T>::operator()(
    T x,
    std::span<const T> xs,
    std::span<const T> ys,
    std::span<const T> dydx,
...
template <std::floating_point T> void HermiteEval<T>::evaluate(
    std::span<const T> x,
    std::span<const T> xs,
    std::span<const T> ys,
    std::span<const T> dydx,
