...
namespace uv
{
        ...
        bool isValidateResults)
    {
        ...
        for (auto& slice : sviVolSurf.slices())
        {
            ...
            CalibratorNLopt<5> calibrator{ prototype.fresh() };
    ...
    void SVI::addWMinConstraint(CalibratorNLopt<5>& calibrator) noexcept
    {
    ...
    void SVI::addMaxSlopeConstraint(CalibratorNLopt<5>& calibrator) noexcept
    {
    ...
    void SVI::addCalendarConstraint(CalibratorNLopt<5>& calibrator,
    ...
    void SVI::addConvexityConstraint(CalibratorNLopt<5>& calibrator, ::std::vector<double>& kStorage) noexcept
    {
    ...
    void SVI::setMinObjective(CalibratorNLopt<5>& calibrator, const ObjCtx& obj) noexcept
    {
